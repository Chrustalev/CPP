...
2. [Part 1](#part-1-реализация-библиотеки-s21_containersh)
3. [Part 2](#part-2-дополнительно-реализация-библиотеки-s21_containersplush)
4. [Part 3](#part-3-дополнительно-реализация-методов-insert_many)
